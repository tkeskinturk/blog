...
I wondered if this was indeed the case and compiled all articles published in the *American Sociological Review* between 1936 and 2019 from the [Constellate](https://constellate.org/), and counted the number of articles that include the words "inequality" or "inequalities" in anywhere in the manuscript.[^1]
...
|           ![Fig](../images/inequality.jpg)           |
|:----------------------------------------------------:|
| *Figure: Inequality in American Sociological Review* |

It is fair to say that *something* happened in sociology over these last few decades. The data show that nearly 4 out of 5 articles published in the ASR mention inequality in one form. If we make a (perhaps dubious) assumption that ASR represents the core output of the discipline, this means that the overwhelming majority of sociologists talks about inequality. This echoes an ethos in our professional culture as well, an example being the conference themes of American Sociological Association within the last few years, reproduced below:
